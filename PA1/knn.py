...
class KNN:
    ...
    def predict(self, features):
        ...
        for feature in features:
            nearest_neighbors = KNN.get_k_neighbors(self,feature)
            counter = Counter(nearest_neighbors)
            predicted_labels.append(counter.most_common()[0][0])
    ...
    def get_k_neighbors(self, point):
        ...
        for feature in self.features:
            ...
            nearest_neighbor_distances.append(distance)
        nearest_neighbor_labels = [x[1] for x in sorted(zip(nearest_neighbor_distances,self.labels))]
        nearest_neighbor_labels = nearest_neighbor_labels[0:self.k]
